...
class GraphsExtendedTuple(NamedTuple):
  """An ordered collection of graphs in a sparse format.
  THE DESCRIPTION IS NOT ACCURATE, IT IS A WORK IN PROGRESS
  ...
  nodes: Optional[ArrayTree]
  value_multiedges: Optional[Tuple[ArrayTree]]
  multiedges: Optional[Tuple[jnp.ndarray]]  # with integer dtype
  globals: Optional[ArrayTree]
  n_node: jnp.ndarray  # with integer dtype
  n_edge_multi: jnp.ndarray   # array of integers with integer dtype